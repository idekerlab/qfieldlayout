...
from qfieldlayout.qfigures import save_networkx_plot, save_layout_convergence_figure, save_layout_time_figure, cx_image_to_file
...
def export_layout_png(nice_cx, input_layout):
    nice_cx.set_opaque_aspect(ndex2.constants.CARTESIAN_LAYOUT_ASPECT, input_layout.get_cx_layout(60))
