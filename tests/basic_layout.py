...
g = ndex2.create_nice_cx_from_file('misc_test_networks/TCR signaling in nave CD4 T cells.cx')

# nest = ndex2.create_nice_cx_from_file('nest_cell_map.cx')
g.print_summary()
g_layout = layout.QFLayout.from_nicecx(g, sparsity=15,
                                       r_radius=10,
                                       a_radius=15,
                                       r_scale=7,
                                       a_scale=20,
                                       center_attractor_scale=0.03,
                                       verbose=True)
